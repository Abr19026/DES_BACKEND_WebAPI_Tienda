    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoriasID = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConceptosPedidos", x => new { x.ProductoID, x.PedidoID });
                    table.ForeignKey(
                        name: "FK_ConceptosPedidos_Pedidos_PedidoID",
                        column: x => x.PedidoID,
                        principalTable: "Pedidos",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConceptosPedidos_Productos_ProductoID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YYExpiracion = table.Column<int>(type: "int", nullable: false),
                    MMExpiracion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConceptosPedidos_PedidoID",
                table: "ConceptosPedidos",
                column: "PedidoID");
